...
func TestQuickSort(t *testing.T) {
	t.Run("ints", func(t *testing.T) {
		...
		sorting.HelperSortOrdered[[]int](t, sorting.QuickSort, tests)
	})
	...
	t.Run("strings", func(t *testing.T) {
		...
		sorting.HelperSortOrdered[[]string](t, sorting.QuickSort, tests)
	})
	...
	t.Run("floats", func(t *testing.T) {
		...
		sorting.HelperSortOrdered[[]float32](t, sorting.QuickSort, tests)
	})
}
